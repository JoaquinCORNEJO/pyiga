...
def power_density(args: dict):
    ...
    for i, t in enumerate(t_list):
        f[:, i] = (
            pi*CST*(12.0*pi*x**2*(0.75*cos(3*pi*t/2) + 1.0)*sin(pi*x**2)*sin(3*pi*y**2)*cos(2*pi*x*y)*tanh(pi*t/2) + 4.0*pi*x**2*(0.75*cos(3*pi*t/2) + 1.0)*sin(3*pi*y**2)*sin(2*pi*x*y)*cos(pi*x**2)*tanh(pi*t/2) + 4.0*pi*x*y*(0.75*cos(3*pi*t/2) + 1.0)*sin(pi*x**2)*sin(3*pi*y**2)*cos(2*pi*x*y)*tanh(pi*t/2) + 48.0*pi*x*y*(0.75*cos(3*pi*t/2) + 1.0)*sin(pi*x**2)*sin(2*pi*x*y)*cos(3*pi*y**2)*tanh(pi*t/2) + 8.0*pi*x*y*(0.75*cos(3*pi*t/2) + 1.0)*sin(3*pi*y**2)*sin(2*pi*x*y)*cos(pi*x**2)*tanh(pi*t/2) - 12.0*pi*x*y*(0.75*cos(3*pi*t/2) + 1.0)*cos(pi*x**2)*cos(3*pi*y**2)*cos(2*pi*x*y)*tanh(pi*t/2) + 76.0*pi*y**2*(0.75*cos(3*pi*t/2) + 1.0)*sin(pi*x**2)*sin(3*pi*y**2)*cos(2*pi*x*y)*tanh(pi*t/2) + 12.0*pi*y**2*(0.75*cos(3*pi*t/2) + 1.0)*sin(pi*x**2)*sin(2*pi*x*y)*cos(3*pi*y**2)*tanh(pi*t/2) + 2.0*(0.75*cos(3*pi*t/2) + 1.0)*sin(pi*x**2)*sin(3*pi*y**2)*sin(2*pi*x*y)*tanh(pi*t/2) - 12.0*(0.75*cos(3*pi*t/2) + 1.0)*sin(pi*x**2)*cos(3*pi*y**2)*cos(2*pi*x*y)*tanh(pi*t/2) - 2.0*(0.75*cos(3*pi*t/2) + 1.0)*sin(3*pi*y**2)*cos(pi*x**2)*cos(2*pi*x*y)*tanh(pi*t/2) + 1.0*(0.75*cos(3*pi*t/2) + 1.0)*sin(pi*x**2)*sin(3*pi*y**2)*cos(2*pi*x*y)/(cosh(pi*t) + 1) - 1.125*sin(3*pi*t/2)*sin(pi*x**2)*sin(3*pi*y**2)*cos(2*pi*x*y)*tanh(pi*t/2))
        )
