...
def power_density(args: dict):
    ...
    for i, t in enumerate(t_list):
        f[:, i] = (
            -pi*(0.32*pi*(0.75*cos(3*pi*t/2) + 1.0)**2*sin(pi*t/2)**2*cos(2*pi*x)**2/cosh((0.015*cos(3*pi*t/2) + 0.02)*sin(pi*t/2)*sin(2*pi*x))**2 - 8*pi*(0.75*cos(3*pi*t/2) + 1.0)*(2.0*tanh((0.015*cos(3*pi*t/2) + 0.02)*sin(pi*t/2)*sin(2*pi*x)) + 3.0)*sin(pi*t/2)*sin(2*pi*x) - (0.75*cos(3*pi*t/2) + 1.0)*sin(2*pi*x)*cos(pi*t/2) + 2.25*sin(pi*t/2)*sin(3*pi*t/2)*sin(2*pi*x))/2
        )
