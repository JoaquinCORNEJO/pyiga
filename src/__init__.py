...
try:
	...
	print("geomdl module is not installed. For conveninece, we will use a homemade module")
	import splines.helpers as helpers
	import splines.BSpline as BSpline
try:
	from pyevtk.hl import gridToVTK
except:
	print("pyevtk module is not installed. Some functions in post-processing may be disabled")
try:
...
try:
	...
	print("pyvista module is not installed. Some functions in post-processing may be disabled")
...
try:
	...
	print(f"Warning: STIX font family is not available. Using default font settings. ({e})")
